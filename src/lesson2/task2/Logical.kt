 ...
 */
fun isNumberHappy(number: Int) = (number % 10 + number / 10 % 10 == number / 100 % 10 + number / 1000)
 ...
 */
fun queenThreatens(x1: Int, y1: Int, x2: Int, y2: Int) = (x1 == x2 || y1 == y2 || abs(x2 - x1) == abs(y2 - y1))
